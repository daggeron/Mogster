 ...
 * MIT license
 */
!(function (e) { if (typeof exports === 'object') { module.exports = e(); } else if (typeof define === 'function' && define.amd) { define(e); } else { var f; typeof window !== 'undefined' ? f = window : typeof global !== 'undefined' ? f = global : typeof self !== 'undefined' && (f = self), f.Bounce = e(); } }(() => {
	var define, module, exports; return (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require === 'function' && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); throw new Error(`Cannot find module '${o}'`); } var f = n[o] = { exports: {} }; t[o][0].call(f.exports, (e) => { var n = t[o][1][e]; return s(n || e); }, f, f.exports, e, t, n, r); } return n[o].exports; } var i = typeof require === 'function' && require; for (var o = 0; o < r.length; o++)s(r[o]); return s; }({ 1: [function (_dereq_, module, exports) {
		...
		Easing = (function () {
			...
			Easing.prototype.findOptimalKeyPoints = function (threshold, resolution) {
				...
				values = function () {
					var _i, _results;
					_results = [];
					for (i = _i = 0; resolution >= 0 ? _i < resolution : _i > resolution; i = resolution >= 0 ? ++_i : --_i)
		...
		Bounce = (function () {
			...
			Bounce.prototype.updateDuration = function () {
				return this.duration = this.components.map((component) => component.duration + component.delay).reduce((a, b) => Math.max(a, b));
			};
			...
			Bounce.prototype.getKeyframes = function (options) {
				...
				if (options.optimized) {
					...
					for (i = _j = 0; frames >= 0 ? _j <= frames : _j >= frames; i = frames >= 0 ? ++_j : --_j)
						keys.push(i / frames);
				}
		...
		MathHelpers = (function () {
			...
			MathHelpers.prototype.findTurningPoints = function (values) {
				...
				turningPoints = [];
				for (i = _i = 1, _ref = values.length - 1; _ref >= 1 ? _i < _ref : _i > _ref; i = _ref >= 1 ? ++_i : --_i) {
