					...
					value: function requestSubscription() {
						...
						var cb = function cb(result) {
							if (result === 'granted') {
								...
								if ('serviceWorker' in navigator) {
									navigator.serviceWorker.register(_this2.workerPath).then(() => {
...
*/
        ...
        return;
					...
					function subscribe(parent, child, onFulfillment, onRejection) {
						var { _subscribers } = parent;
						var { length } = _subscribers;
     ...
     */
					...
					value: function show() {
						...
						if (this.options.animation.open === null) {
							this.promises.show = new _es6Promise2.default((resolve) => {
								resolve();
							});
							...
							this.promises.show = new _es6Promise2.default((resolve) => {
								Utils.addListener(_this.barDom, Utils.animationEndEvents, () => {
     ...
     */
					...
					value: function close() {
						...
						if (this.options.animation.close === null) {
							this.promises.close = new _es6Promise2.default((resolve) => {
								resolve();
							});
							...
							this.promises.close = new _es6Promise2.default((resolve) => {
								Utils.addListener(_this4.barDom, Utils.animationEndEvents, () => {
